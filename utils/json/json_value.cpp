...
//NO_ASSERT add by wuwl 2020-6-18
#define NO_ASSERT
#ifdef NO_ASSERT
#define JSON_FAIL_MESSAGE( message ) printf( message );
#else
...
: cstr_( other.index_ != noDuplication &&  other.cstr_ != 0
                ...
                : other.cstr_ )
   , index_( other.cstr_ ? (other.index_ == (int)noDuplication ? (int)noDuplication : (int)duplicate)
                         : other.index_ )
{
}
...
Value::asString() const
{
   ...
   default:
      //JSON_ASSERT_UNREACHABLE;//modify by wuwl 2020-6-18
       break;
   }
   return ""; // unreachable
}
